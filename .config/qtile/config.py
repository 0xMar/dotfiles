...
from typing import List  # noqa: F401import

##### DEFINING SOME VARIABLES #####
mod = "mod4"                                     # Sets mod key to SUPER/WINDOWS
myTerm = "xterm"                             # My terminal of choice
# The Qtile config file location
myConfig = "/home/victor/.config/qtile/config.py"
...
keys = [
    ...
    Key(
        [mod, "mod1"], "u",
        lazy.spawn(myTerm+" -e sudo pacman -Syu"),
        desc='pacman'
    ),
    Key(
        [mod, "mod1"], "a",
        lazy.spawn(myTerm + " -e yay -Sua"),
        desc='yay'
    ), Key(
        [mod, "mod1"], "y",
...
#        ),
        ...
        widget.Memory(
            ...
            background=colors[5],
            mouse_callbacks={
                'Button1': lambda qtile: qtile.cmd_spawn(myTerm + ' -e top')},
            padding=5
        ),
        widget.Net(
            interface='all',
